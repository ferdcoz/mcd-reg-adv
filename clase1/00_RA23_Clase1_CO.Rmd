...
## [Ejemplo 1: Índice de masa corporal infantil.]{style="color:darkred"}
...
IMCinfantil<-read_excel("./datasets/IMCinfantil.xlsx")
...
Como no se cumple el supuesto de normalidad bivariada recurrimos al cálculo de correlación de Spearman.
...
## [Ejemplo 2: Gorriones]{style="color:darkred"}
...
## [Modelos Lineales]{style="color:darkred"}
...
## [Comparación de modelos]{style="color:darkred"}
...
## [Estimación de coeficientes y recta de regresión]{style="color:darkred"}
...
**Observación:** Hay diferencias entre el resultado obtenido en la significación del coef. de Cuerpo en el modelo (se ve que es significativo) y la significancia del test de WALD de ese mismo coeficiente del mismo modelo. Puede deberse a que exista colinealidad entre las variables y el modelo confunde la significatividad de las mismas.
...
## [Predicción e intervalos de confianza]{style="color:darkred"}
...
## [Validación de supuestos y análisis diagnóstico]{style="color:darkred"}
...
Concluimos que no se rechaza homocedasticidad. <br>
