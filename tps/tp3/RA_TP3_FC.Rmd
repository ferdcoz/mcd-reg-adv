...
```{r}
#Puedo ver si existen valores outliers

v_datos <- quimicos_clean
...
for (i in 2:ncol(v_datos)){
  ...
  df[i-1,2:12] <- c(q1,q3,iqr,ModSup,ModInf,SevSup,SevInf,OutModSup,OutModInf,OutSevSup,OutSevInf)
